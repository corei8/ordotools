...
sanctoral = {
    '01/14': {
        ...
        'rank': [15, 'd'],
        'comm2': {'S Felix SM': {'mass': {'int': 'Lætabitur', 'glo': True, 'cre': True, 'pre': 'Communis'}}},
        'comm3': '',
        'office_proper': True,
    ...
    '01/15': {
        ...
        'rank': [15, 'd'],
        'comm2': {'S Mauri Abb': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Missa', 'glo': True, 'cre': True, 'pre': 'Communis'},
    ...
    '01/16': {
        'feast': 'S Marcelli PM',
        'rank': [16.1, 'sd'],
        'comm2': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Missa', 'glo': True, 'cre': True, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    ...
    '01/18': {
        ...
        'rank': [14, 'dm'],
        'comm2': {'S Pauli Apostoli': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'S Priscæ VM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Missa', 'glo': True, 'cre': True, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '01/19': {
        ...
        'rank': [22, 's'],
        'comm2': {'S Canuti RM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Missa', 'glo': True, 'cre': True, 'pre': 'Communis'},
        'mag': '',
    },
    ...
    '01/23': {
        ...
        'rank': [16.1, 'sd'],
        'comm2': {'S Emerentianæ VM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Missa', 'glo': True, 'cre': True, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    ...
    '01/28': {
        ...
        'rank': [15, 'd'],
        'comm2': {'S Agnetis VM secundo': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Missa', 'glo': True, 'cre': True, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    ...
    '02/06': {
        'feast': 'S Titi EC',
        'rank': [15, 'd'],
        'comm2': {'S Dorotheæ VM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '02/09': {
        'feast': 'S Cyrilli ECD',
        'rank': [15, 'd'],
        'comm2': {'S Apollonia VM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '03/04': {
        'feast': 'S Casimiri C',
        'rank': [16.1, 'sd'],
        'comm2': {'S Lucii I PM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '04/14': {
        'feast': 'S Iustini M',
        'rank': [15, 'd'],
        'comm2': {'Ss Tiburtio, Valeriano et Maximo Mm': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '09/08': {
        ...
        'rank': [10, 'd II cl'],
        'comm2': {'S Hadriano M': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '09/15': {
        ...
        'rank': [10, 'd II cl'],
        'comm2': {'S Nicomede M': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '09/16': {
        ...
        'rank': [16.1, 'sd'],
        'comm2': {'Ss Euphemia V, Lucia & Geminiano Mm': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '09/20': {
        ...
        'rank': [15, 'd'],
        'comm2': {'In Vigilia S Matthæi ApEv': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '09/22': {
        ...
        'rank': [15, 'd'],
        'comm2': {'Ss Mauritio & Soc Mm': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Statuit', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '09/23': {
        'feast': 'S Lini',
        'rank': [16.1, 'sd'],
        'comm2': {'S Thecla VM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '10/07': {
        ...
        'rank': [10, 'd II cl'],
        'comm2': {'S Marco PC': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'Ss Sergio, Baccho, Marcello & Apulejo MM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Gaudeamus', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '10/08': {
    ...
    '10/09': {
        ...
        'rank': [15, 'd'],
        'comm2': {'Ss Dionysii E, Rustici & Eleutherii Mm': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '10/21': {
        ...
        'rank': [21, 's'],
        'comm2': {'Ss Ursula & Sociabus VM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Os justi', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    ...
    '11/04': {
        'feast': 'S Caroli EC',
        'rank': [15, 'd'],
        'comm2': {'Ss Vitale & Agricola Mm': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '11/09': {
        ...
        'rank': [10, 'd II cl'],
        'comm2': {{'private': True, 'com': 'S Theodoro M'}: {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '11/10': {
        ...
        'rank': [15, 'd'],
        'comm2': {'Ss Tryphone, Respicio & Nympha VM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Os justi', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '11/11': {
        'feast': 'S Martini  EC',
        'rank': [15, 'd'],
        'comm2': {'S Menna M': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Statuit ei', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    ...
    '11/19': {
        ...
        'rank': [15, 'd'],
        'comm2': {'S Pontiano PM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Cognovi', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    ...
    '11/23': {
        ...
        'rank': [15, 'd'],
        'comm2': {'S Felicitate M': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '11/24': {
        ...
        'rank': [15, 'd'],
        'comm2': {'S Chrysogono M': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'In medio', 'glo': True, 'cre': True, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    ...
    '11/26': {
        ...
        'rank': [15, 'd'],
        'comm2': {'S Petro Alexandrino EM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Os justi', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '11/29': {
        ...
        'rank': [18, 'v'],
        'comm2': {'S Saturnino M': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '12/04': {
        ...
        'rank': [15, 'd'],
        'comm2': {'S Barbara VM': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}}},
        'comm3': {'': {'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'In medio', 'glo': True, 'cre': True, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
