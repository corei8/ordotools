...
sanctoral = {
    ...
    '05/25': {
        ...
        'rank': [15, 'd'],
        'comm2': {'feast': 'S Urbano I PM', 'mass': {'int': 'Si diligis', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '05/26': {
        ...
        'rank': [15, 'd'],
        'comm2': {'feast': 'S Eleutherio PM', 'mass': {'int': 'Si diligis', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '05/27': {
        ...
        'rank': [15, 'd'],
        'comm2': {'feast': 'S Joanne I PM', 'mass': {'int': 'Si diligis', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'In medio', 'glo': True, 'cre': True, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''}
    },
    '05/28': {
    ...
    '05/31': {
        ...
        'rank': [15, 'd'],
        'comm2': {'feast': 'S Petronilla V', 'mass': {'int': 'Vultum tuum', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Dilexisti', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''}
    },
    '06/02': {
    ...
    '07/02': {
        ...
        'rank': [10, 'd II cl'],
        'comm2': {'feast': 'Ss Processo & Martiniano Mm', 'mass': {'int': 'Sapientiam', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '07/12': {
        ...
        'rank': [15, 'd'],
        'comm2': {'feast': 'Ss Nabore & Felice Mm', 'mass': {'int': 'Salus autem', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Os justi', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '07/13': {
    ...
    '07/18': {
        ...
        'rank': [15, 'd'],
        'comm2': {'feast': 'Ss Symphorosa & septem Filiis ejus Mm', 'mass': {'int': 'Clamaverunt', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '07/20': {
        ...
        'rank': [15, 'd'],
        'comm2': {'feast': 'S Margarita VM', 'mass': {'int': 'Me expectaverunt', 'glo': True, 'cre': False, 'pre': 'Communis'}},
    ...
    '07/23': {
        ...
        'rank': [15, 'd'],
        'comm2': {'feast': 'S Liborio EC', 'mass': {'int': 'Statuit', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Sacerdotes Dei', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '07/24': {
        ...
        'rank': [18, 'v'],
        'comm2': {'feast': 'S Christina VM', 'mass': {'int': 'Me expectaverunt', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Ego autem', 'glo': False, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '07/25': {
        'feast': 'S Jacobi Ap',
        'rank': [10, 'd II cl'],
        'comm2': {'feast': 'S Christophori M', 'mass': {'int': '', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Mihi autem', 'glo': True, 'cre': True, 'pre': 'de Apostolis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '07/26': {
    ...
    '07/29': {
        'feast': 'S Marthæ V',
        'rank': [16.1, 'sd'],
        'comm2': {'feast': 'Ss Felice I P, Simplicis, Faustino & Beatrice Mm', 'mass': {'int': 'Sapientiam', 'glo': True, 'cre': False, 'pre': 'Communis'}},
        'mass': {'int': 'Dilexisti', 'glo': True, 'cre': False, 'pre': 'Communis'},
        'vespers': {'proper': False, 'admag': '', 'propers': {}, 'oration': ''},
    },
    '07/30': {
