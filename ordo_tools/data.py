...
##      "nobility": False
##  },
##  str(easter(year) - week(6-c) - indays(2)): {
...
##      "nobility": False
##  },
##  str(easter(year) - week(6-c) - indays(1)): {
...
##  cycle.update(
##  {
##      str(easter(year) - week(6-c) + indays(j+1)): {
...
##      cycle.update(
##      {
##      str(easter(year) + week(i) + indays(3)): {
...
##      str(easter(year) + week(i + 1) + indays(3)): {
...
##  cycle.update(
##  {
##      str(easter(year) + week(i) + indays(1)): {
...
##      },
##      str(easter(year) + week(i) + indays(2)): {
...
##      },
##      str(easter(year) + week(i) + indays(4)): {
##          "feast": "Ascensio DNJC",
...
##          "nobility": False
##      },
##      str(easter(year) + week(i) + indays(4+7)): {
...
##          "nobility": False
##      },
##      str(easter(year) + week(i+1) + indays(5)): {
...
##          "nobility": False
##      },
##      str(easter(year) + week(i+1) + indays(6)): {
...
##          cycle.update(
##          {
##          str(post_pent_count + week(p) + indays(3)): {
...
##              "nobility": False
##          },
##          str(post_pent_count + week(p) + indays(5)): {
...
##              "nobility": False
##          },
##          str(post_pent_count + week(p) + indays(6)): {
...
##      "nobility": False
##  },
##  str(lastadvent - week(i) + indays(3)): {
...
##      "nobility": (9, 2, 6, 13, 3, 0),
##  },
##      str(lastadvent - week(i) + indays(5)): {
...
##      cycle.update(
##      {
##      str(christmas + indays(7) - findsunday(christmas)): {
